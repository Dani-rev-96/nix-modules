...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc) — fzf-lua
    'ibhagwan/fzf-lua',
    event = 'VimEnter',
    dependencies = {
    ...
    config = function()
      ...
      fzf.setup {
        -- fzf-lua uses fzf-native by default for speed
        -- Preview is enabled automatically for file pickers
      }

      -- See `:help fzf-lua` for all available actions
      -- File search
  ...
  { -- You can easily change to a different colorscheme.
    ...
    --
    -- If you want to see what colorschemes are already installed, you can use `:Fzf colorscheme`.
